...
서울시 S-DoT 스마트 센서 데이터(2025년 8월)를 활용해 기온·소음·자외선·대기오염·생활인구를 지도 위에 시각화하는 웹 애플리케이션입니다.
...
| 데이터 | 출처 | 기간 |
|--------|------|------|
| S-DoT 센서 (기온·소음·UV·NO₂) | [서울 열린데이터광장](https://data.seoul.go.kr/dataList/OA-15969/S/1/datasetView.do) | 2025년 8월 주간 평균 (06~18시) |
| 생활인구 250m 격자 | [서울시 생활인구 (KT 빅데이터)](https://data.seoul.go.kr) | 2025년 8월 평일 주간 시간당 평균 |
